package com.trasim.myapp.screens.common.issuesTypeSelectionBottomSheetDialog.adapters
...
class IssueTypeOptionsListAdapter(private val selectedItem: IssueTypeLocal?, private val adapterItems: MutableList<IssueTypeLocal>, val handler: IssueTypeSelectionBottomSheetDialogHandler) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        viewHolder.optionNameTV.text = option.name
        ...
        viewHolder.simpleSelectionItemHolderCL.setOnClickListener {
            handler.onIssueTypeSelected(option)
